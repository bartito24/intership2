...
<div class="card-header"><center><h4>Iniciar tramite</h4></center></div>
                <form action="../../enrutador/enr_inicio_tramite.php" method="post">
                    <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4"><select id="estudiante" name="estudiante" class="selectpicker" data-show-subtext="true" data-live-search="true" required>
                            ...
                            {
                                echo "<option value='$datos_estudiante[id_estudiante]'>$datos_estudiante[nombre] $datos_estudiante[papellido] $datos_estudiante[sapellido]</option>";
                            }
                            ?>
                        </select></div>
